...
rec.plot <- ggplot(data = rec, mapping = aes(x = population, y = total_expenditures)) + geom_point() + labs(x="Population", y="Total Expenditures", title="Total Recreation Expenditures and Population of American Cities in 1930")
```
